...
{
    public class TenantDBContextContext : TenanciableDbContext
    {
        public TenantDBContextContext(ISimpleUser user, IIdentifiableModel tenant) : base(user, tenant) { }

        private DbSet<TestModel> testModels { get; set; }
        private DbSet<TenanciableTestModel> tenantTestModels { get; set; }
